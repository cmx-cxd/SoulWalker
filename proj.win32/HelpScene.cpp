...
bool HelpScene::init()
{
	if (Layer::init())
	{
		...
		//说明图
		auto pic = Sprite::create("resources/help_scene.png");
		pic->setPosition(Vec2(visibleSize.width / 2 + origin.x, visibleSize.height / 2 + origin.y));
		this->addChild(pic, LAYER_0);
		//返回按钮图
		auto back = MenuItemImage::create("resources/button_back_up.png", "resources/button_back_down.png", CC_CALLBACK_1(HelpScene::backToMainScene, this));
...
void HelpScene::backToMainScene(Ref* sender) {
